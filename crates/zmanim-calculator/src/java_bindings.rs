        ...
        pub mod zmanim {
            ...
            bind_java_type! {
                ...
                methods {
                    ...
                    ///
                    /// # Returns
                    /// the <code>Instant</code> representing Sun's lower transit at the end of the current day. If the calculation can't
                    ...
                    ///
                    /// # Returns
                    /// the <code>Instant</code> representing Sun's transit. If the calculation can't be computed such as when using
                    ...
                    ///
                    /// # Returns
                    /// the <code>Instant</code> representing the exact sunset time. If the calculation can't be computed such as in
                    ...
                    ///
                    /// # Returns
                    /// The {@link java.time.Instant} of the offset after (or before) {@link #getSunsetWithElevation()}. If the calculation can't
            ...
            bind_java_type! {
                ...
                methods {
                    ...
                    fn get_fixed_local_chatzos() -> "java.time.Instant",
            ...
            bind_java_type! {
                ...
                methods {
                    ...
                    fn get_chatzos2 {
                        name = "getChatzos",
                        sig = (begin: "java.time.Instant", end: "java.time.Instant") -> "java.time.Instant",
                    },
                    ...
                    /// it does not set, a <code>null</code> will be returned. See detailed explanation on top of the
                    /// {@link AstronomicalCalendar} documentation.
                    fn get_chatzos_as_half_day() -> "java.time.Instant",
