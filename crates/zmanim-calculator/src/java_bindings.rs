...
pub mod zmanim {
    ...
    bind_java_type! {
        ...
        methods {
            ...
            ///
            /// # Returns
            /// the <code>Instant</code> representing Sun's lower transit at the <b>end of the current day</b>. If the calculation
    ...
    bind_java_type! {
        ...
        methods {
            ...
            ///
            /// # Returns
            /// the <code>Instant</code> of <em>chatzos halayla</em> at the <b>end of the current day</b>. If the calculation can't be
