...
```markdown
Misheyakir according to some opinions, when the sun is 11.5 degrees below geometric zenith.

In Jerusalem [around the equinox or equilux](https://kosherjava.com/2022/01/12/equinox-vs-equilux-zmanim-calculations/), this matches about 52 minutes before sunrise.
